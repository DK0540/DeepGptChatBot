...
function App() {
  ...
  const apiKey = "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";
  //Old key= const apiKey = "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";
  //New Key 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
...
// import chat from "./Assets/Group126.png";
// import sendbtn from "./Assets/send.png";
// // import sendbtn from "./Assets/send.png";import botlogo from "./Assets/botlogo2.png";
...
//                 <img
//                   className={`logo ${message.type}-logo`}
//                   src={`./icons/${message.type}-logo.png`}
//                   alt={`${message.type} icon`}
//                 />
//               </div>
//               <div className="text-container">
